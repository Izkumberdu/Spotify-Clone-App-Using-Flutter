...
class _AlbumQueuePageState extends State<AlbumQueuePage> {
  ...
  void initState() {
    super.initState();
    _isSelected =
        List.generate(widget.songHandler.queue.value.length, (index) => false);
  }
        ...
        GestureDetector(
          onLongPress: () {
            setState(() {
              ...
              _isSelected =
                  List.filled(widget.songHandler.queue.value.length, false);
            });
          },
          child: IconButton(
        ...
        builder: (context, snapshot) {
          ...
          if (playingSong == null) {
            return const SizedBox
                .shrink(); // Hide the widget if no song is playing
          } else {
            return Row(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: const Color.fromARGB(
                          255, 44, 54, 41), // Change color as needed
